...
for(i in 1:9){
  ...
  for(j in 1:nrow(dat)){
    ...
    if(!is.na(dat[j, "issue_primary"]) &&
       !is.na(dat[j, "domestic_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_primary"] == i && dat[j, "domestic_ngo"] == 1){
      dcount = dcount + 1
    }
    if(!is.na(dat[j, "issue_secondary"]) &&
       !is.na(dat[j, "domestic_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_secondary"] == i && dat[j, "domestic_ngo"] == 1){
      dcount = dcount + 1
    }
    if(!is.na(dat[j, "issue_tertiary"]) &&
       !is.na(dat[j, "domestic_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_tertiary"] == i && dat[j, "domestic_ngo"] == 1){
      dcount = dcount + 1
    }
    
    #look for foreign ngo occurrences for that issue
    if(!is.na(dat[j, "issue_primary"]) &&
       !is.na(dat[j, "foreign_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_primary"] == i && dat[j, "foreign_ngo"] == 1){
      fcount = fcount + 1
    }
    if(!is.na(dat[j, "issue_secondary"]) &&
       !is.na(dat[j, "foreign_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_secondary"] == i && dat[j, "foreign_ngo"] == 1){
      fcount = fcount + 1
    }
    if(!is.na(dat[j, "issue_tertiary"]) &&
       !is.na(dat[j, "foreign_ngo"]) &&
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_tertiary"] == i && dat[j, "foreign_ngo"] == 1){
      fcount = fcount + 1
    }
    ...
    if(!is.na(dat[j, "issue_primary"]) &&
       ...
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_primary"] == i && dat[j, "foreign_ngo"] == 0 && dat[j, "domestic_ngo"] == 0){
      ncount = ncount + 1
    }
    if(!is.na(dat[j, "issue_secondary"]) &&
       !is.na(dat[j, "foreign_ngo"]) &&
       ...
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_secondary"] == i && dat[j, "foreign_ngo"] == 0 && dat[j, "domestic_ngo"] == 0){
      ncount = ncount + 1
    }
    if(!is.na(dat[j, "issue_tertiary"]) &&
       !is.na(dat[j, "foreign_ngo"]) &&
       ...
       !is.na(dat[j, "cao"]) &&
       dat[j, "cao"] == 0 &&
       dat[j, "issue_tertiary"] == i && dat[j, "foreign_ngo"] == 0 && dat[j, "domestic_ngo"] == 0){
      ncount = ncount + 1
    }
