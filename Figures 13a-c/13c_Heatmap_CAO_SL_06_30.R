...
CAOdata <- separated$"1" #make a dataframe with only CAO data

allcountries <- sapply(CAOdata$country, tolower) #get the column "country" from the data, transform to lowercase
